...
@Component({
  selector: 'sb-add-archaeology-news',
  templateUrl: './add-archaeology-news.component.html',
  styleUrls: ['./add-archaeology-news.component.scss']
})
export class AddArchaeologyNewsComponent implements OnInit {
  images : any[] = [];
  msg = "";
  ...
  onMultipleSubmit(userData:any){
    if(userData.valid){
      ...
      this._auth.addArchaeologyNews(formData).subscribe(result=> console.log(result))
