...
@Component({
  selector: 'sb-add-fine-art-news',
  templateUrl: './add-fine-art-news.component.html',
  styleUrls: ['./add-fine-art-news.component.scss']
})
export class AddFineArtNewsComponent implements OnInit {
  images : any[] = [];
  msg = "";
  ...
  onMultipleSubmit(userData:any){
    if(userData.valid){
      ...
      this._auth.addFineArtNews(formData).subscribe(result=> console.log(result))
